  ...
  return (
    ...
    >
      ...
      <div className="px-3 py-5 ">
        <Link to="/" className="flex justify-start mb-3 ml-3">
          {/* <img src={logo} alt="Logo" className="w-40" /> */}
          <h1 className="text-2xl font-bold text-[#DAA520] dark:text-[#DAA520]">
            EVENTOPIA
          </h1>
        </Link>
        <hr />
                  ...
                  className={`flex items-center gap-3 py-2 px-4 rounded-lg font-medium transition group 
                    ${
                      activeIcon === item.link
                        ...
                        : "text-zinc-700 dark:text-zinc-100 hover:bg-blue-600 hover:text-white"
                    }`}
                >
                  <span
                    className={`text-xl ${
