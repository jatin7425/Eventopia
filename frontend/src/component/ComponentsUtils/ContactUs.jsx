      ...
      <div className="grid sm:grid-cols-2 dark:bg-zinc-800 px-10 py-7 rounded-lg items-center gap-16 my-6 mx-auto max-w-1/2 ">
        ...
        <form className="ml-auo space-y-4" onSubmit={handleSubmit}>
          <input
            ...
            name="name"
            placeholder="Name"
            className="w-full rounded-md py-3 px-4 bg-[#f8f9ff] outline-cyan-900 dark:text-black"
            required
          />
          <input
            type="email"
          ...
          <textarea
            ...
            placeholder="Message"
            rows="6"
            className="w-full rounded-md px-4 bg-[#f8f9ff] pt-3 outline-cyan-900 dark:text-black"
            required
          ></textarea>
          <ButtonArrow
            type="submit"
