...
export const OchiFooter = ({ marginTop, contactLink }) => {
  return (
    <motion.div
      id="footer"
    ...
    >
      <div className="w-full px-[3.5vw] flex items-start max-sm:flex-col max-sm:w-full ">
        <div className="w-1/2 max-sm:hidden max-sm:w-full">
          <h1 className='text-6xl max-lg:text-5xl max-md:text-4xl font-["Founders_Grotesk_Condensed"] font-semibold uppercase pt-20 '>
            Effortless <br /> Event{" "}
            <span className="max-lg:block inline">Planning</span>
          </h1>
        </div>
        <div className="w-1/2 mt-20 max-sm:w-full">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <br />{" "}
              <a href={contactLink} className="hover:text-blue-500">
                Contact us
              </a>
              <br />
            </div>
      ...
      <div
        className={`w-full max-sm:w-full ${marginTop} mt-10 max-xs:flex-col max-xs:justify-end h-20 dark:bg-zinc-800 bg-white px-[3.5vw] flex items-center justify-between `}
      >
        <div className="">
          <h1 className="text-2xl font-semibold font-['Founders_Grotesk_Condensed']">
            Eventopia
          </h1>
        </div>
